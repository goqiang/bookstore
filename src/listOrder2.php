...
<?php	
    ...
    $sql="select * from  orders where user='$user' order by orderID desc";
	$stmt=$con->query($sql);
	...
	foreach($records as $record)
	{
	  ...
	  echo "<tr><td class='imgs'>$imgs</td><td>$total</td><td>$deliverMode<br>$paymentMode</td><td>$datetime</td><td>$orderState<br><a href='order-detail.php?orderID=$orderID'>订单详情</a></td><td>删除订单</td></tr>";
	}
	echo "</table>";
